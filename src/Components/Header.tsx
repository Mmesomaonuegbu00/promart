        ...
        <div className='flex justify-between items-center w-[95%] lg:w-[85%] mx-auto gap-3'>
          ...
          <div className='relative w-[150px] sm:w-[350px] lg:w-[400px]'>
            ...
            {isFocused && search.length < 2 && (
              <div className='absolute top-full mt-2 w-full bg-white px-4 py-3 rounded shadow z-20'>
            ...
            {isFocused && search.length > 1 && (
              <div className='absolute top-full mt-2 w-full bg-white border border-gray-300 rounded shadow z-20 max-h-60 overflow-y-auto'>
